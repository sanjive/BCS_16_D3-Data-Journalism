...
function makeResponsive() {
  //This functions allows for responsive chart

  var svgArea = d3.select("body").select("svg");

  //clear the SVG dhart area before recreating it on size change
  if (!svgArea.empty()) { svgArea.remove(); }

  //Allows for use of realtive sizing
...
} // end of function makeResponsive()

// Invoke the function makeResponsive on initial page load
makeResponsive();

// Event handler for resize of the browser window
// Aloows for the function makeResponsive to repaint the re-sized chart
